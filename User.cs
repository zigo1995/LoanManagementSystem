...
namespace LoanManagementSystem.Domain.Entities
{
    ...
    public class Loan
    {
        ...
        public string LoanType { get; set; } // Personal, Business, Education
    ...
    public class Installment
    {
        ...
        public string Status { get; set; } // Pending, Paid, Overdue, Partial
    ...
    public class Payment
    {
        ...
        public string PaymentMethod { get; set; } // Cash, Check, Bank Transfer
