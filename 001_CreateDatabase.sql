...
CREATE TABLE [dbo].[Loans] (
    ...
    [Status] NVARCHAR(20) NOT NULL, -- Active, Completed, Defaulted
    [LoanType] NVARCHAR(50) NOT NULL, -- Personal, Business, Education
...
CREATE TABLE [dbo].[Installments] (
    ...
    [Status] NVARCHAR(20) NOT NULL, -- Pending, Paid, Overdue, Partial
    [PaidDate] DATE NULL,
...
CREATE TABLE [dbo].[Payments] (
    ...
    [PaymentMethod] NVARCHAR(50) NOT NULL, -- Cash, Check, Bank Transfer
